...
# set xvlog options
xvlog_opts="--relax  -L uvm -L axi_vip_v1_1_19 -L smartconnect_v1_0 -L processing_system7_vip_v1_0_21 -L xilinx_vip"
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/elysia/Software/Xilinx/Vivado/2024.2/data/xsim"
  fi

...
module design_1
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 UART_1_0 RxD" *) (* X_INTERFACE_MODE = "Master" *) input UART_1_0_rxd;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 UART_1_0 TxD" *) output UART_1_0_txd;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ADC_CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ADC_CLK, CLK_DOMAIN design_1_ADC_3PA1030_0_1_o_adc_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) output adc_clk;
  output dac_clk_out;
  output [13:0]dac_data_out;
  input [9:0]i_adc_data;

  wire [15:0]ADC_3PA1030_0_adc_data_out;
  wire [15:0]ASK_DM_0_am_data_out;
  ...
  wire [15:0]FSK_DM_0_data_out_17;
  wire [15:0]IQ_DDC_0_i_band;
  wire IQ_DDC_0_iq_tvalid;
  wire [15:0]IQ_DDC_0_q_band;
  wire [15:0]PSK_DM_0_pm_data_out;
  wire UART_0_0_rxd;
  wire UART_0_0_txd;
  wire UART_1_0_rxd;
  wire UART_1_0_txd;
  wire adc_clk;
  wire [15:0]axi_gpio_select_gpio_io_o;
  ...
  wire [15:0]data_select_0_DAC_data;
  wire [9:0]i_adc_data;
  ...
  wire [15:0]waveform_measure_ASK_frequency;
  wire [31:0]waveform_measure_ASK_mean_square;
  wire [15:0]waveform_measure_ASK_o_signal_dc_removed;
  wire [15:0]waveform_measure_ASK_v_max;
  wire [15:0]waveform_measure_ASK_v_min;
  wire [31:0]waveform_measure_FSK_mean_square;
  wire [15:0]waveform_measure_FSK_o_signal_dc_removed;
  wire [15:0]waveform_measure_FSK_period_sample_cnt;
  wire [15:0]waveform_measure_FSK_v_max;
  wire [15:0]waveform_measure_FSK_v_min;
  wire [15:0]waveform_measure_PSK_frequency;
  wire [31:0]waveform_measure_PSK_mean_square;
  wire [15:0]waveform_measure_PSK_o_signal_dc_removed;
  wire [15:0]waveform_measure_PSK_v_max;
  wire [15:0]waveform_measure_PSK_v_min;
  wire [31:0]xlconcat_0_dout;

  design_1_ADC_3PA1030_0_1 ADC_3PA1030_0
       (.aresetn(rst_ps7_0_50M_peripheral_aresetn),
        .clk(clk_wiz_0_clk_out1),
        .i_adc_data(i_adc_data),
        .o_adc_clk(adc_clk),
        .o_adc_data(ADC_3PA1030_0_adc_data_out));
  design_1_ASK_DM_0_2 ASK_DM_0
       (.am_data_in(xlconcat_0_dout),
        .am_data_out(ASK_DM_0_am_data_out),
        .clk(clk_wiz_0_clk_out1),
        .iq_tvalid(IQ_DDC_0_iq_tvalid),
        .rst_n(rst_ps7_0_50M_peripheral_aresetn));
  design_1_DAC_904_0_0 DAC_904_0
       (.DAC_clk(clk_wiz_0_clk_out1),
        .aresetn(rst_ps7_0_50M_peripheral_aresetn),
        .dac_clk_out(dac_clk_out),
        .dac_data(dac_data_out),
        .data_tc16(data_select_0_DAC_data));
  design_1_FSK_DM_0_0 FSK_DM_0
       (.clk(clk_wiz_0_clk_out1),
        .fm_data_in(xlconcat_0_dout),
        .fm_data_out(FSK_DM_0_data_out_17),
        .iq_tvalid(IQ_DDC_0_iq_tvalid),
        .rst_n(rst_ps7_0_50M_peripheral_aresetn));
  design_1_IQ_DDC_0_0 IQ_DDC_0
       (.clk(clk_wiz_0_clk_out1),
        .i_band(IQ_DDC_0_i_band),
        .iq_data_in(ADC_3PA1030_0_adc_data_out),
        .iq_tvalid(IQ_DDC_0_iq_tvalid),
        .q_band(IQ_DDC_0_q_band),
        .rst_n(rst_ps7_0_50M_peripheral_aresetn));
  design_1_PSK_DM_0_0 PSK_DM_0
       (.clk(clk_wiz_0_clk_out1),
        .pm_data_in(ADC_3PA1030_0_adc_data_out),
        .pm_data_out(PSK_DM_0_pm_data_out),
        .rst_n(rst_ps7_0_50M_peripheral_aresetn));
  design_1_axi_gpio_0_0 axi_gpio_ask_0
       (.gpio2_io_i(waveform_measure_ASK_v_min),
        .gpio_io_i(waveform_measure_ASK_v_max),
  ...
  design_1_axi_gpio_ask_0_0 axi_gpio_ask_1
       (.gpio2_io_i(waveform_measure_ASK_mean_square),
        .gpio_io_i(waveform_measure_ASK_frequency),
        .s_axi_aclk(clk_wiz_0_clk_out1),
  ...
  design_1_axi_gpio_0_1 axi_gpio_ctrl
       (.gpio_io_o(axi_gpio_select_gpio_io_o),
        .s_axi_aclk(clk_wiz_0_clk_out1),
  ...
  design_1_axi_gpio_ask_0_1 axi_gpio_fsk_0
       (.gpio2_io_i(waveform_measure_FSK_v_min),
        .gpio_io_i(waveform_measure_FSK_v_max),
        .s_axi_aclk(clk_wiz_0_clk_out1),
  ...
  design_1_axi_gpio_ask_0_2 axi_gpio_fsk_1
       (.gpio2_io_i(waveform_measure_FSK_mean_square),
        .gpio_io_i(waveform_measure_FSK_period_sample_cnt),
        .s_axi_aclk(clk_wiz_0_clk_out1),
  ...
  design_1_axi_gpio_0_2 axi_gpio_psk_0
       (.gpio2_io_i(waveform_measure_PSK_v_min),
        .gpio_io_i(waveform_measure_PSK_v_max),
        .s_axi_aclk(clk_wiz_0_clk_out1),
  ...
  design_1_axi_gpio_ask_0_3 axi_gpio_psk_1
       (.gpio2_io_i(waveform_measure_PSK_mean_square),
        .gpio_io_i(waveform_measure_PSK_frequency),
        .s_axi_aclk(clk_wiz_0_clk_out1),
  ...
  design_1_axi_smc_1 axi_smc
       (.M00_AXI_araddr(axi_smc_M00_AXI_ARADDR),
        ...
        .aresetn(rst_ps7_0_50M_peripheral_aresetn));
  design_1_data_select_0_0 data_select_0
       (.AM_data(waveform_measure_ASK_o_signal_dc_removed),
        .DAC_data(data_select_0_DAC_data),
        .FM_data(waveform_measure_FSK_o_signal_dc_removed),
        .PSK_data(waveform_measure_PSK_o_signal_dc_removed),
        .SELE(axi_gpio_select_gpio_io_o),
        .clk(clk_wiz_0_clk_out1),
        .rst_n(rst_ps7_0_50M_peripheral_aresetn));
  design_1_ila_0_0 ila_0
       (.clk(clk_wiz_0_clk_out1),
        .probe0(ADC_3PA1030_0_adc_data_out),
        .probe1(waveform_measure_ASK_o_signal_dc_removed),
        .probe2(waveform_measure_FSK_o_signal_dc_removed),
        .probe3(waveform_measure_PSK_o_signal_dc_removed),
        .probe4(dac_data_out));
  design_1_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_0_addr),
        ...
        .UART1_RX(UART_1_0_rxd),
        .UART1_TX(UART_1_0_txd));
  ...
  design_1_waveform_measure_0_0 waveform_measure_ASK
       (.data_in(ASK_DM_0_am_data_out),
        .mean_square(waveform_measure_ASK_mean_square),
        .o_signal_dc_removed(waveform_measure_ASK_o_signal_dc_removed),
        .period_sample_cnt(waveform_measure_ASK_frequency),
        .rst_n(rst_ps7_0_50M_peripheral_aresetn),
        .sys_clk(clk_wiz_0_clk_out1),
        .v_max(waveform_measure_ASK_v_max),
        .v_min(waveform_measure_ASK_v_min));
  design_1_waveform_measure_0_1 waveform_measure_FSK
       (.data_in(FSK_DM_0_data_out_17),
        .mean_square(waveform_measure_FSK_mean_square),
        .o_signal_dc_removed(waveform_measure_FSK_o_signal_dc_removed),
        .period_sample_cnt(waveform_measure_FSK_period_sample_cnt),
        .rst_n(rst_ps7_0_50M_peripheral_aresetn),
        .sys_clk(clk_wiz_0_clk_out1),
        .v_max(waveform_measure_FSK_v_max),
        .v_min(waveform_measure_FSK_v_min));
  design_1_waveform_measure_0_2 waveform_measure_PSK
       (.data_in(PSK_DM_0_pm_data_out),
        .mean_square(waveform_measure_PSK_mean_square),
        .o_signal_dc_removed(waveform_measure_PSK_o_signal_dc_removed),
        .period_sample_cnt(waveform_measure_PSK_frequency),
        .rst_n(rst_ps7_0_50M_peripheral_aresetn),
        .sys_clk(clk_wiz_0_clk_out1),
        .v_max(waveform_measure_PSK_v_max),
        .v_min(waveform_measure_PSK_v_min));
